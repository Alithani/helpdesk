     ...
     if(!isset($_SESSION['email']) /*== TRUE*/)
      ...
      if(isset($_POST['send']) ) 
      {
        ...
        //image upload
          $rgen = rand(1,100);
          $target_dir = "../images/";
          $target_file = $target_dir.$rgen.basename($_FILES["avatar"]["name"]);
          $uploadOk = 1;
          $imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
          $new_name = $target_dir.$rgen.basename($_FILES["avatar"]["name"]);        
          ...
          $avatarimg = $rgen.basename($_FILES["avatar"]["name"]);
    ...
    <center>
      ...
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9">
          <button type="submit" class="btn btn-success" name="send" id="sendbtn">Submit Ticket</button>
        </div>
      </div>
    </fieldset>
  </form>
